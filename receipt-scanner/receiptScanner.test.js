const receiptFileCollector = require('../screens/receiptFileCollector');
const receiptDataExtractor = require('../screens/receiptDataExtractor');
const assert = require('chai').assert;
const testCollector = new receiptFileCollector();

// instantiate a test version for data extractor with receipt uri from testCollector
const testDataExtractor = new receiptDataExtractor(testCollector.getFileUri());
...
describe ("testing data extracted by veryfi ", function() {
      it("tests item values: description, quantity, units from receipt", function(){
        testReceiptItemList = []
        receiptItemListFromExtractor = testDataExtractor.getReceiptItemList()
